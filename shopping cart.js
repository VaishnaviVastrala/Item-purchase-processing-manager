...
for (const product in productPrices) {
    quantities[product] = parseInt(prompt(How many Quantity of "Product ${product}" You Want?));
    giftWrappers[product] = parseInt(prompt(How many "Product ${product}" with Gift Wrappers You Want?));
}
